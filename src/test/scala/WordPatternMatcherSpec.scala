...
class WordPatternMatcherSpec extends AnyFunSpec with Matchers {
  describe("Word Matches Matching Detail") {
    it("returns true if the word matches AInPosHint positions") {
      val wordPattern = List(('T', AInPosHint), ('R', AInPosHint), ('A', AMissHint), ('C', AMissHint), ('E', AInPosHint))
    ...
    it("return true if the word contains AInWordHint letters but not at the AInWordHint position") {
      val wordPattern = List(('T', AMissHint), ('R', AMissHint), ('A', AInWordHint), ('C', AInWordHint), ('E', AMissHint))
    ...
    it("return false if the word contains any black letters, but letter is not a AInPosHint or AInWordHint letter as well") {
      val wordPattern = List(('T', AMissHint), ('R', AMissHint), ('A', AMissHint), ('C', AMissHint), ('E', AMissHint))
    ...
    it("puts it all together") {
      val wordPattern = List(('T', AInPosHint), ('R', AMissHint), ('A', AInWordHint), ('C', AMissHint), ('E', AInPosHint))
    ...
    it("handles multiple letter cases") {
      ...
      val wordPattern1G1B = List(('A', AMissHint), ('A', AInPosHint), ('X', AMissHint), ('Y', AMissHint), ('Z', AMissHint))
      ...
      val wordPattern2G1B = List(('A', AInPosHint), ('X', AMissHint), ('A', AMissHint), ('Y', AMissHint), ('A', AInPosHint))
      ...
      val wordPattern1Y1B = List(('A', AInWordHint), ('A', AMissHint), ('X', AMissHint), ('Y', AMissHint), ('Z', AMissHint))
      ...
      val wordPattern2Y1B = List(('A', AInWordHint), ('X', AMissHint), ('A', AInWordHint), ('Y', AMissHint), ('A', AMissHint))
      ...
      val wordPattern1G1Y1B = List(('A', AInWordHint), ('X', AMissHint), ('A', AMissHint), ('Y', AMissHint), ('A', AInPosHint))
